...
ServoCal servos[] = {
  ...
  {  973, 2002,  0,  8, "L4" },  //  3   ML-Coxa
  { 1007, 1925,  0,  9, "L5" },  //  4   ML-Femur
  {  932, 1947,  0,  10, "L6" },  //  5   ML-Tibia
  { 1016, 2137,  0,  12, "L7" },  //  6   BL-Coxa
  {  956, 1868,  0,  13, "L8" },  //  7   BL-Femur
  {  976, 2069,  0,  14, "L9" },  //  8   BL-Tibia
  // ── Right board (0x41) ────────────────────────────────────────────────────
  { 1038, 2032,  1,  0, "R1" },  //  9   FR-Coxa
  { 1043, 1962,  1,  1, "R2" },  // 10   FR-Femur
  {  918, 1962,  1,  2, "R3" },  // 11   FR-Tibia
  {  956, 1983,  1,  8, "R4" },  // 12   MR-Coxa
  { 1092, 2014,  1,  9, "R5" },  // 13   MR-Femur
  {  938, 1990,  1,  10, "R6" },  // 14   MR-Tibia
  {  930, 1998,  1,  12, "R7" },  // 15   BR-Coxa
  { 1052, 1973,  1,  13, "R8" },  // 16   BR-Femur
  {  995, 1978,  1,  14, "R9" }   // 17   BR-Tibia
};
