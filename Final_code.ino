...
const ServoCal SVO[18] = {
  ...
  {  970, 1990,  0,  0 },  //  0  FL-Coxa   (re-calibrated)
...
// NOTE: signs reversed so neighbours now shift TOWARD the disabled leg.
//          L1     L2     L3     R1     R2     R3
const float COG[6][6] = {
...
const float TUCK_TB = +40.0f;  // tibia curls UP (raised) so the fold looks natural
